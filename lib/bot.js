                ...
                jiraApi.findIssue(jira, function (error, issue) {
                  ...
                  if (issue && self.config.post == true) {
                    ...
                    if (self.config.showIssueDetails && expandInfo) {
                      msg += ' _' + (issue.fields.summary || issue.key) + '_';
                      if (verbose) {
                        console.log(issue);
                      }
                      // msg += ' | *' + issue.fields.status.name + '*';
                      // if (issue.fields.assignee) {
                      //   msg += ' | assignee: _' + issue.fields.assignee.displayName + '_';
                      // } else if (issue.fields.customfield_10801) {
                      //   msg += ' | responsible: _' + issue.fields.customfield_10801.displayName + '_';
                      // } else if (issue.fields.creator) {
                      //   msg += ' | reporter: _' + issue.fields.creator.displayName + '_';
                      // }
